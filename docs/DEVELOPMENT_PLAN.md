...
- **Acceptance Criteria**: Running `sentinel enroll <username>` displays camera window, guides user through 5 poses, and registers valid `gallery.npy` vectors with daemon. ✅ **Met.**
